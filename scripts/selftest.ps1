<#
.SYNOPSIS
  Runs "SuperDownloader-Portable.exe --selftest <report>" with a time limit and prints the report.
...
#>
param(
    [string]$Exe = (Join-Path (Split-Path -Parent $PSScriptRoot) 'dist\SuperDownloader-Portable.exe'),
